...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/ausbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ausbit Core"),
     ...
     * override -datadir in the ausbit.conf file in the default data directory
     * (to be consistent with ausbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
