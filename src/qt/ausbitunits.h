...
#ifndef AUSBIT_QT_AUSBITUNITS_H
#define AUSBIT_QT_AUSBITUNITS_H
...
/** Ausbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AusbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AusbitUnits(QObject *parent);

    /** Ausbit units.
      @note Source: https://en.ausbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ABT,
...
typedef AusbitUnits::Unit AusbitUnit;

#endif // AUSBIT_QT_AUSBITUNITS_H
