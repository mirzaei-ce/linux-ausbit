...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ausbit Core ausbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ausbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ausbit transaction") + "\n" +
              "  ausbit-tx [options] -create [commands]   " + _("Create hex-encoded ausbit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ausbit transaction
