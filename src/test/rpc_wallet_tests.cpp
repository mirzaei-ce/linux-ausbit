...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAusbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAusbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CAusbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAusbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAusbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAusbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
