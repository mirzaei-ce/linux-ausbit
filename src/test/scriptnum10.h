...
#ifndef AUSBIT_TEST_SCRIPTNUM10_H
#define AUSBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ausbit Core 0.10.0, for cross-comparison.
 */
public:
