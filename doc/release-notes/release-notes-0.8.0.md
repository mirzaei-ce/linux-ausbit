Ausbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ausbit/files/Ausbit/ausbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ausbit
...
New/changed settings (command-line or ausbit.conf file)
--------------------------------------------------------
