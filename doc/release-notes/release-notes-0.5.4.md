Ausbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ausbit/files/Ausbit/ausbit-0.5.4/
...
http://gitorious.org/ausbit/ausbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ausbit-Qt notifications under Growl 1.3.
Increase required age of Ausbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAusbit properly when installing Ausbit-Qt over it. (Windows)
