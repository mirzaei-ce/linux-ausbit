Ausbit Core version 0.10.3 is now available from:

  <https://ausbit.org/bin/ausbit-core-0.10.3/>
...
(see https://github.com/ausbit/ausbit/pull/6793, as well as the 0.11.0
