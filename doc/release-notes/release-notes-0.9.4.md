Ausbit Core version 0.9.4 is now available from:

  https://ausbit.org/bin/0.9.4/
...
this update is incompatible with the Ausbit system and could lead to consensus
forks.

Ausbit Core released binaries from https://ausbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ausbit/+archive/ubuntu/ausbit
- A third-party or self-compiled Ausbit Core

upgrade to Ausbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
