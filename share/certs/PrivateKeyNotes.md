...
unlocked to sign the Ausbit-Qt.app bundle.
...
allowing somebody to distribute a Ausbit-Qt.app or ausbit-qt-setup.exe with a valid
...
that the ausbit-qt.exe file inside the installer had not been tampered with.
