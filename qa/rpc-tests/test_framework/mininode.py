# mininode.py - Ausbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a ausbit node
...
# Objects that map to ausbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in ausbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Ausbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
